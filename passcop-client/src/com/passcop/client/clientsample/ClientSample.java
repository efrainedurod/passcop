...
//		Persona persona = port1.consultarServicioPersona("1804073268", new Short("1"));
		...
		res.setCalificacionRiesgoCOD("AAA"); // Preguntar
		res.setCarteraRiesgo(new BigDecimal("100"));
		res.setCastigoDemanda(new BigDecimal("100"));
		res.setCastigoDemanda12Meses(new BigDecimal("100"));
		...
		resCenRiCony.setCarteraRiesgo(new BigDecimal("101"));
		resCenRiCony.setCastigoDemanda(new BigDecimal("101"));
		resCenRiCony.setCastigoDemanda12Meses(new BigDecimal("101"));
		resCenRiCony.setIdentificacionCentralRiesgo("1234567891");
		resCenRiCony.setMensaje("Mensaje");
		resCenRiCony.setMontoTotalEndeudamiento(new BigDecimal("101"));
		...
		resCenRiCony.setTotalCarteraVigente(new BigDecimal("101"));
		// Se crea el objeto RespuestaCentralRiesgo
		RespuestaCentralRiesgo resCenRiConSoc = new RespuestaCentralRiesgo();
		resCenRiConSoc.setCalificacionRiesgoCOD("A"); // Consultar
		resCenRiConSoc.setCarteraRiesgo(new BigDecimal("101"));
		resCenRiConSoc.setCastigoDemanda(new BigDecimal("101"));
		resCenRiConSoc.setCastigoDemanda12Meses(new BigDecimal("101"));
		resCenRiConSoc.setIdentificacionCentralRiesgo("1234567891");
		resCenRiConSoc.setMensaje("Mensaje");
		resCenRiConSoc.setMontoTotalEndeudamiento(new BigDecimal("101"));
		...
		resCenRiConSoc.setTotalCarteraVigente(new BigDecimal("101"));
		// Se crea el objeto RespuestaCentralRiesgo
		RespuestaCentralRiesgo resRiesGar = new RespuestaCentralRiesgo();
		resRiesGar.setCalificacionRiesgoCOD("A"); // Consultar
		resRiesGar.setCarteraRiesgo(new BigDecimal("101"));
		resRiesGar.setCastigoDemanda(new BigDecimal("101"));
		resRiesGar.setCastigoDemanda12Meses(new BigDecimal("101"));
		resRiesGar.setIdentificacionCentralRiesgo("1234567891");
		resRiesGar.setMensaje("Mensaje");
		resRiesGar.setMontoTotalEndeudamiento(new BigDecimal("101"));
		...
		resRiesGar.setTotalCarteraVigente(new BigDecimal("101"));
		// Se crea el objeto RespuestaCentralRiesgo
		RespuestaCentralRiesgo resRiesSoc = new RespuestaCentralRiesgo();
		resRiesSoc.setCalificacionRiesgoCOD("A"); // Consultar
		resRiesSoc.setCarteraRiesgo(new BigDecimal("101"));
		resRiesSoc.setCastigoDemanda(new BigDecimal("101"));
		resRiesSoc.setCastigoDemanda12Meses(new BigDecimal("101"));
		resRiesSoc.setIdentificacionCentralRiesgo("1234567891");
		resRiesSoc.setMensaje("Mensaje");
		resRiesSoc.setMontoTotalEndeudamiento(new BigDecimal("101"));
		...
		resRiesSoc.setTotalCarteraVigente(new BigDecimal("101"));
		...
		personaCon.setIdentificacion("1234567892");
		personaCon.setIdentificacionConyuge("1234567891");
		...
		personaCon.setTelefonoDomicilio("1234567891");
		personaCon.setTelefonoCelular("1234567891");
		...
		personaConSoc.setIdentificacionConyuge("1234567891");
		...
		personaConSoc.setTelefonoDomicilio("1234567891");
		personaConSoc.setTelefonoCelular("1234567891");
		...
		res.setCostosTotalesPerdidasYGanancias(new BigDecimal("102"));
		res.setCostototal(new BigDecimal("102"));
		res.setCuoraCredito(new BigDecimal("102"));
		res.setCuotaCreditoVigente(new BigDecimal("102"));
		...
		res.setDestinoEconomicoCOD("OT"); // Destino de fondos
		...
		detPatSoc.setValorDetallePatrimonial(new BigDecimal("1000"));
		// Se crea el objeto Detalle Patrimonio Socio
		...
		detPatSoc2.setValorDetallePatrimonial(new BigDecimal("2000"));
		...
		detCuen1.setValorDetalleCuentas(new BigDecimal("1000"));
		...
		detCuen2.setValorDetalleCuentas(new BigDecimal("10001"));
		...
		detCuen3.setValorDetalleCuentas(new BigDecimal("1000"));
		...
		detCuen4.setValorDetalleCuentas(new BigDecimal("10001"));
		...
		res.setDisponibilidadAntesCredito(new BigDecimal("10000"));
		res.setDisponibleNeto(new BigDecimal("5000"));
		res.setDuenoCasa("SAN JOSE DE MORAN");
		res.setEgresosFamiliar(new BigDecimal("800"));
		res.setEgresosFamiliaresTotalPerdidasYGanancias(new BigDecimal("800"));
		res.setEgresosNegocio(new BigDecimal("200"));
		res.setEgresosNegocioPerdidasYGanancias(new BigDecimal("200"));
		...
		personaGarante.setTelefonoDomicilio("1234567891");
		personaGarante.setTelefonoCelular("1234567891");
		...
		garReal1.setAvaluoComercial(new BigDecimal("2000"));
		garReal1.setComercio(true);
		garReal1.setCuotaCreditoVigente(new BigDecimal("2000"));
		...
		garReal1.setIdentificacion("1234567891");
		garReal1.setIngreso(null);
		garReal1.setLatitud(new BigDecimal("1212122222222"));
		garReal1.setLongitud(new BigDecimal("1212122222222"));
		...
		garReal1.setValor(new BigDecimal("20000"));

		GarantiasReales garReal2 = new GarantiasReales();
		garReal2.setAnioFabricacionConstruccion(1986);
		garReal2.setAvaluoComercial(new BigDecimal("2000"));
		garReal2.setComercio(true);
		garReal2.setCuotaCreditoVigente(new BigDecimal("2000"));
		...
		garReal2.setIdentificacion("1234567891");
		garReal2.setIngreso(null);
		garReal2.setLatitud(new BigDecimal("1212122222222"));
		garReal2.setLongitud(new BigDecimal("1212122222222"));
		...
		garReal2.setValor(new BigDecimal("20000"));

		List<GarantiasReales> garReales = new ArrayList<GarantiasReales>();
		garReales.add(garReal1);
		garReales.add(garReal2);

		res.setGastosFinancierosPerdidasYGanancias(new BigDecimal("5000"));
		res.setGastosTotalesPerdidasYGanancias(new BigDecimal("5000"));
		res.setIVA(new BigDecimal("500"));
		res.setIdentificacion("1234567891");
		...
		res.setIngreso(null);
		res.setIngresosFamiliar(new BigDecimal("12000"));
		res.setIngresosFamiliaresTotalPerdidasYGanancias(new BigDecimal("12100"));
		res.setIngresosNegocio(new BigDecimal("50"));
		res.setInteresesAmortizacion(true);
		res.setLatitud(new BigDecimal("123124322342323"));
		res.setLocalidadCOD("");
		res.setLongitud(new BigDecimal("123124322342323"));
		...
		res.setModuloID(6);
		res.setMontoSolicitud(new BigDecimal("2000"));
		...
		res.setPatrimonioMontos(new BigDecimal("100000"));
		...
		res.setPrimerInteres(new BigDecimal("12"));
		res.setPrimeraCuota(new BigDecimal("120"));
		...
		refComer.setValor(new BigDecimal("10000"));
		...
		refComer2.setValor(new BigDecimal("10000"));
		...
		personaSoc.setIdentificacionConyuge("1234567891");
		...
		personaSoc.setTelefonoDomicilio("1234567891");
		personaSoc.setTelefonoCelular("1234567891");
		personaSoc.setTieneError(false);
		personaSoc.setMensaje("D204");

		res.setSocio(personaSoc);
		res.setSolicitudID(123);
		res.setTasa(new BigDecimal("12.5"));
		...
		res.setTotalCarteraVigente(new BigDecimal("1000"));
		res.setTotalEgresos(new BigDecimal("1000"));
		res.setTotalIngresosFlujo(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasEGRESOSGarante(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasEGRESOSSocio(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasINGRESOSGarante(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasINGRESOSSocio(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasINGRESOSGarante(new BigDecimal("1000"));
		res.setTotalValorDetalleDeCuentasINGRESOSSocio(new BigDecimal("1000"));
		res.setTotalValorDetallePatrimonial(new BigDecimal("1000"));
		res.setTotalValorDetallePatrimonialGarante(new BigDecimal("1000"));
		res.setTotalValorPatrimonioACTIVOGarante(new BigDecimal("1000"));
		res.setTotalValorPatrimonioACTIVOSocio(new BigDecimal("1000"));
		res.setTotalValorPatrimonioPASIVOGarante(new BigDecimal("1000"));
		res.setTotalValorPatrimonioPASIVOSocio(new BigDecimal("1000"));
		...
		res.setUtilidadNegocioTotalPerdidasYGanancias(new BigDecimal("10000"));
		res.setUtilidadNetaPersidasYGanancias(new BigDecimal("10000"));
		res.setValorReferenciasComerciales(new BigDecimal("10000"));
		res.setVentasMontos(new BigDecimal("10000"));
		res.setVentasTotalesPerdidasYGanancias(new BigDecimal("10000"));
