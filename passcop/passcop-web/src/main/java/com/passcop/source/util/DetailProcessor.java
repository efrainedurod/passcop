...
public class DetailProcessor implements Serializable {
	...
	public Detail getSolicitudData(String[] pProductFit, int pPersonaId, Short pUsuarioIdSol, Short pUsuarioId,
			...
			BigDecimal pMontoSolicitud, String pTipoCuota, String pFrecuencia, Integer pNumCuotas, Integer pPlazo,
	...
	public Table getTproductoCuotas(String[] pProductFit, BigDecimal pMonto, String pFrecuencia, Integer pPlazo,
